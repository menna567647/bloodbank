  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
              <a href={{ route('admin.home') }} class="nav-link"> {{ __('messages.home') }}
              </a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
              <a href="#" class="nav-link"> {{ __('messages.contact') }}
              </a>
          </li>
      </ul>
      ...
      <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                  ...
                  <div class="dropdown-divider"></div>
                  <a href="#" class="dropdown-item">
                      <i class="fas fa-envelope mr-2"></i> {{$messages_count}} new messages
                      <span class="float-right text-muted text-sm">1 day</span>
                  </a>
                  <div class="dropdown-divider"></div>
                  <a href="#" class="dropdown-item">
                      <i class="fas fa-users mr-2"></i> {{$clients_count}} clients
                      <span class="float-right text-muted text-sm">1 week</span>
                  </a>
                  <div class="dropdown-divider"></div>
                  <a href="{{route('admin.reports.index')}}" class="dropdown-item">
                      <i class="fas fa-file mr-2"></i>{{$reports_count}} new reports
          ...
          <li class="nav-item">
              <a class="nav-link btn btn-outline-warning mr-3" href="{{ route('admin.password') }}">
