                ...
                <ol class="breadcrumb mb-0 p-2 bg-light" style="float: left;">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @foreach ($categories as $item)
                            <li class="nav-item">
                                <a href="{{ route('admin.byCategory', $item->id) }}"
                                    class="nav-link {{ request()->is('admin/post/' . $item->id) ? 'active' : '' }}">
                                    <i
                                        class="{{ request()->is('admin/post/' . $item->id) ? 'fas fa-dot-circle' : 'far fa-circle' }} nav-icon"></i>
                        ...
                        <div class="row justify-content-center">
                            ...
                            @empty
                                <div class="alert alert-info text-center">
                                    <i class="fas fa-info-circle"></i> {{ __('messages.No posts in this category') }}
                                </div>
                            @endforelse
                        </div>
