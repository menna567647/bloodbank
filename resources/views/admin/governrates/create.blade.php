                    ...
                    <form method="POST" action="{{ route('admin.governorates.store') }}">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="name" class="form-label">
                                    {{ __('messages.Governorate') }}
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="name" id="name"
                                    class="form-control @error('name') is-invalid @enderror"
                                    placeholder="{{ __('messages.Enter Governorate name') }}" value="{{ old('name') }}">
                        ...
                        <div class="card-footer bg-light">
                            <div class="d-flex justify-content-start align-items-center">
                                ...
                                <a href="{{ route('admin.governorates.index') }}" class="btn btn-outline-success btn-sm"><i class="fa-solid fa-arrow-right"></i> {{ __('messages.back') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
