        ...
        <div class="row mb-2">
            <div class="col-12">
                <ol class="breadcrumb mb-0 p-2 bg-light" style="float: left;">
                    ...
                    <li class="breadcrumb-item active">{{ __('messages.bloodtypesList') }}</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <a class="btn btn-outline-primary btn-sm" href="{{ route('admin.bloodtypes.create') }}">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('messages.numberofclients') }}</th>
                            ...
                            <tbody>
                                @foreach ($Bloodtypes as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button"
                                                data-url="{{ route('admin.bloodtypes.destroy', $item->id) }}"
